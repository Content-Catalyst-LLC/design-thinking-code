...
echo "Running professional testing and validation companion workflows..."
...
if command -v python3 >/dev/null 2>&1; then
  ...
  python3 testing_validation_engine.py \
...
if command -v sqlite3 >/dev/null 2>&1; then
  ...
  sqlite3 outputs/testing_validation.db < sql/analytical_queries.sql > outputs/sql_analysis_results.txt
else
