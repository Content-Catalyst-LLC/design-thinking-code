...
echo "Running professional design thinking companion workflows..."
...
if command -v python3 >/dev/null 2>&1; then
  ...
  python3 design_strategy_engine.py \
...
if command -v sqlite3 >/dev/null 2>&1; then
  ...
  sqlite3 outputs/design_thinking.db < sql/analytical_queries.sql > outputs/sql_analysis_results.txt
else
