...
echo "Running professional insight-generation companion workflows..."
...
if command -v python3 >/dev/null 2>&1; then
  ...
  python3 insight_generation_engine.py \
...
if command -v sqlite3 >/dev/null 2>&1; then
  ...
  sqlite3 outputs/insight_generation.db < sql/analytical_queries.sql > outputs/sql_analysis_results.txt
else
