...
echo "Running professional iteration and experimentation companion workflows..."
...
if command -v python3 >/dev/null 2>&1; then
  ...
  python3 iteration_experimentation_engine.py \
...
if command -v sqlite3 >/dev/null 2>&1; then
  ...
  sqlite3 outputs/iteration_experimentation.db < sql/analytical_queries.sql > outputs/sql_analysis_results.txt
else
