...
echo "Running professional design-thinking strategy companion workflows..."
...
if command -v python3 >/dev/null 2>&1; then
  ...
  python3 strategy_design_engine.py \
...
if command -v sqlite3 >/dev/null 2>&1; then
  ...
  sqlite3 outputs/strategy_design.db < sql/analytical_queries.sql > outputs/sql_analysis_results.txt
else
