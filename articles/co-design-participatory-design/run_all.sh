...
echo "Running professional co-design and participatory design companion workflows..."
...
if command -v python3 >/dev/null 2>&1; then
  ...
  python3 co_design_participatory_design_engine.py \
...
if command -v sqlite3 >/dev/null 2>&1; then
  ...
  sqlite3 outputs/codesign_participatory_design.db < sql/analytical_queries.sql > outputs/sql_analysis_results.txt
else
